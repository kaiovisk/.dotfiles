...
# Utilities.
yay -S feh scrot zathura zathura-pdf-mupdf-git pfetch bottom dunst --no-confirm
...
# SwayWM essentials and beyond.
yay -S nitrogen rofi picom --no-confirm
# Stuff for polybar.
...
# BEWARE: Intended for NVIDIA cards only! (REMOVE COMMENTS IF NEEDED)
